    ...
    <div className="min-h-screen  flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-lg bg-white/20 backdrop-blur-xl shadow-2xl rounded-3xl border border-white/30 p-8 text-white bg-gradient-to-br from-[#3A0CA3] via-[#7209B7] to-[#B5179E]">
        ...
        <div className="flex flex-col items-center">
          ...
          />
          <h2 className="text-3xl font-bold mt-4">{user?.displayName || "No Name Available"}</h2>
        ...
        <div className="mt-8 bg-white/10 p-5 rounded-2xl shadow-md hover:bg-white/20 transition">
          ...
          <p className="text-purple-200 text-sm leading-relaxed">
            Welcome to your GameHub profile! Track your favorite games, see your stats, 
            and enjoy a personalized gaming library experience.
          </p>
        </div>
        <button onClick={handleOpenForm} className="btn mt-2 items-center">Update Profile</button>
